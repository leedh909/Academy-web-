...
CREATE TABLE MYMEMBER(
	...
	CONSTRAINT MEMBER_RK PRIMARY KEY(MYNO),
...
INSERT INTO MYMEMBER VALUES(MYNOSEQ.NEXTVAL,'USER1','USER1','이창진',
'서울시 강남구 역삼동','010-2222-3333','USER1@MYMEMBER.COM','Y','USER');

INSERT INTO MYMEMBER VALUES(MYNOSEQ.NEXTVAL,'USER2','USER2','홍길동',
'경기도 수원시 권선구','010-3333-4444','USER2@MYMEMBER.COM','N','USER');
