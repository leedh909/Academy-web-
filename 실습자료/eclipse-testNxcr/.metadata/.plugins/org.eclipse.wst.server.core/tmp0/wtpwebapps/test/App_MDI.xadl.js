(function()
{
    return function()  
	{
        ...
        this.on_initApplication = function()
        {
            ...
            // frame
            var mainframe = this.createMainFrame("mainframe","0","0","800","800",null,null,this);
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            var frame4 = new ChildFrame("WorkFrame",null,null,null,null,null,null,"Work::form_Test.xfdl",frame2);
            frame4.set_showtitlebar("false");
            frame4.set_showstatusbar("false");
            frame2.addChild(frame4.name, frame4);
            frame4.set_formurl("Work::form_Test.xfdl");
        };
        ...
        this.loadCss("xcssrc::ss.xcss");
        this.loadIncludeScript("App_MDI.xadl");
    };
}
)();
