(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid00","20","134","210","222",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Div("Div00","280","134","460","545",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            ...
            obj = new Edit("Edit00","110","47","420","63",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);

            obj = new Button("Button00","550","47","180","65",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("검색");
            this.addChild(obj.name, obj);
        ...
        this.Button00_onclick = function(obj,e)
        {
        	...
        	var row = _application.gds_emp.findRow("FULL_NAME",str);

        	alert(row);
        	_application.gds_emp.set_rowposition(row);
